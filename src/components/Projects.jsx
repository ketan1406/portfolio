  ...
  return (
    <motion.div variants={fadeIn("up", "spring")}>
      <Tilt
        ...
        className="bg-tertiary p-1.5 rounded-2xl sm:w-[160px] w-full"
      >
        ...
        <div className="mt-5">
          <h3 className="text-white font-bold text-[11px]">{name}</h3>
          <p className="mt-2 text-secondary text-[7px]">{description}</p>
        </div>
